...
public abstract class DocumentScrollProperties
{
    ...
    private readonly IDocumentControl? _parent;

    protected private IDocumentControl? ParentControl => _parent;

    internal bool _visible;
    private bool _enabled = true;

    protected private DocumentScrollProperties(IDocumentControl? container)
    {
        _parent = container;
    }
    ...
    private protected abstract int GetPageSize(IDocumentControl parent);

    private protected abstract SCROLLBAR_CONSTANTS Orientation { get; }

    private protected abstract int GetHorizontalDisplayPosition(IDocumentControl parent);

    private protected abstract int GetVerticalDisplayPosition(IDocumentControl parent);
