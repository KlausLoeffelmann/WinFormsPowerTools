...
public partial class ThemingColors
{
    ...
    private static ThemingColors GetDefaultDarkModeColors()
    {
        return new ThemingColors
        {
            ...
            ButtonFace = 0xFF323232.ToColor(),
            ButtonHighlight = 0xFF464646.ToColor(),
            ButtonShadow = 0xFF282828.ToColor(),
            Control = 0xFF202020.ToColor(),
            ControlDark = 0xFF2D2D2D.ToColor(),
            ControlDarkDark = 0xFF191919.ToColor(),
            ControlLight = 0xFF3C3C3C.ToColor(),
            ControlLightLight = 0xFF464646.ToColor(),
            ...
            Menu = 0xFF191919.ToColor(),
            MenuBar = 0xFF1E1E1E.ToColor(),
            MenuHighlight = 0xFF3399FF.ToColor(),
